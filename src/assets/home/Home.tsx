                ...
                <section id="contacto_hero">
                    ...
                    <form
                        className="formulario"
                          action="https://formsubmit.co/eduardo.orozcoservin@gmail.com"
                        method="POST"
                    >
                        <fieldset>
                            ...
                            <div className="contenedor-campos">
                                <div className="campo">
                                    <label >Nombre</label>
                                    <input name="nombre" className="input-text" type="text" placeholder="Tu nombre" required />
                                </div>

                                <div className="campo">
                                    <label >Teléfono</label>
                                    <input name="telefono" className="input-text" type="tel" placeholder="Tu teléfono" required />
                                </div>

                                <div className="campo">
                                    <label >Correo</label>
                                    <input name="correo" className="input-text" type="email" placeholder="Tu Email" required />
                                </div>

                                <div className="campo">
                                    <label >Mensaje</label>
                                    <textarea name="mensaje" className="input-text" required></textarea>
                                </div>
                            </div>
                            {/* <!-- contenedor campos --> */}
